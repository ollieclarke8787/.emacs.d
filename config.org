...
#+begin_src emacs-lisp
  (use-package julia-repl
    ...
    (setq julia-repl-executable-records
      '((default "/extra/tmp/qlsv71/bin/julia")                  ; in the executable path
        (master "julia"))) ; compiled from the repository
    (setq exec-path (append exec-path '("/extra/tmp/qlsv71/bin")))
    (add-to-list 'load-path "/extra/tmp/qlsv71/bin/julia"))
#+end_src
** eglot-jl
...
#+begin_src emacs-lisp
  (use-package copilot
    ...
    :custom
    (copilot--base-dir "/home/qlsv71/.emacs.d/straight/repos/copilot.el/")
